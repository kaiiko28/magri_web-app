    ...
    <x-slot name="slot">
        ...
        <div class="osahan-map">
            ...
            <section class="section bg-white osahan-track-order-page position-relative">
                <iframe allowfullscreen class="position-absolute" frameborder="0" height="676" src="{{asset('frontend')}}/https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d13696.650704896498!2d75.82434255!3d30.8821099!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1555184720550!5m2!1sen!2sin" style="border:0" width="100%"></iframe>
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-md-6">
                            <div class="bg-white p-4 shadow-lg rounded mb-2">
                                <div class="mb-2">
                                    <small>Order #25102589748<a class="float-right font-weight-bold" href="#"><i class="feather-help-circle"></i> HELP</a></small>
                                </div>
                                <h6 class="mb-1 mt-1"><a class="text-black" href="{{route('restaurant')}}">Spice Hut Restaurant</a></h6>
                            ...
                            <div class="bg-white p-4 shadow-lg rounded">
                                <div class="osahan-track-order-detail po">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <small>FROM</small>
                                            <h6 class="mb-1 mt-1"><a class="text-black" href="{{route('restaurant')}}"><i class="feather-shopping-cart"></i> Spice Hut Restaurant</a></h6>
                                            <p class="text-gray mb-5">2036, NEW YORK</p><small>DELIVER TO</small>
                                            <h6 class="mb-1 mt-1"><span class="text-black"><i class="feather-map-pin"></i> Other</span></h6>
                                            <p class="text-gray mb-0">291, Jawaddi Kalan, Ludhiana, Punjab 141002, India</p>
                                        </div>
                                        <div class="col-md-7">
                                            <div class="mb-2">
                                                <small><i class="feather-list"></i> 5 ITEMS</small>
                                            </div>
                                            ...
                                            <p class="mb-0 text-info"><small>Paid via Credit/Debit card <span class="float-right text-danger">$620 OFF</span></small></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="bg-white p-4 shadow-lg rounded mt-2">
                                <div class="row text-center">
                                    <div class="col">
                                        ...
                                        <p class="mt-1 font-weight-bold text-dark mb-0">Order Received</p><small class="text-info mb-0">NOW</small>
                                    </div>
                                    <div class="col">
                                        <i class="feather-check-circle h4 icofont-3x text-success"></i>
                                        <p class="mt-1 font-weight-bold text-dark mb-0">Order Confirmed</p><small class="text-success mb-0">NEXT</small>
                                    </div>
                                    <div class="col">
                                        <i class="feather-truck h4 icofont-3x text-primary"></i>
                                        <p class="mt-1 font-weight-bold text-dark mb-0">Order Picked Up</p><small class="text-primary mb-0">LATER (ET : 30min)</small>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container slider_restaurant py-5 border-top">
                <div class="trending-slider">
                    <div class="osahan-slider-item px-1">
                        <div class="list-card bg-white h-100 d-flex align-items-center rounded overflow-hidden position-relative shadow-sm">
                            <div class="list-card-image">
                                <a href="{{route('restaurant')}}"><img alt="#" class="img-fluid item-img" src="{{asset('frontend')}}/img/trending1.png"></a>
                            </div>
                            <div class="p-3 position-relative">
                                <div class="list-card-body">
                                    <h6 class="mb-1"><a class="text-black" href="{{route('restaurant')}}">Dave's Bar-B-Que</a></h6>
                    ...
                    <div class="osahan-slider-item px-1">
                        <div class="list-card bg-white h-100 d-flex align-items-center rounded overflow-hidden position-relative shadow-sm">
                            <div class="list-card-image">
                                <a href="{{route('restaurant')}}"><img alt="#" class="img-fluid item-img" src="{{asset('frontend')}}/img/trending2.png"></a>
                            </div>
                            <div class="p-3 position-relative">
                                <div class="list-card-body">
                    ...
                    <div class="osahan-slider-item px-1">
                        <div class="list-card bg-white h-100 d-flex align-items-center rounded overflow-hidden position-relative shadow-sm">
                            <div class="list-card-image">
                                <a href="{{route('restaurant')}}"><img alt="#" class="img-fluid item-img" src="{{asset('frontend')}}/img/trending3.png"></a>
                            </div>
                            <div class="p-3 position-relative">
                                <div class="list-card-body">
