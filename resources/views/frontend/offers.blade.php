        ...
        <div class="offer-section">
            <div class="container">
                <div class="py-5 d-flex align-items-center">
                    ...
                    <div class="ml-auto"><img alt="#" src="{{asset('frontend')}}/img/offers.png" class="img-fluid offers_img"></div>
                </div>
            </div>
        </div>
                ...
                <div class="bg-white">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="px-0 py-3 nav-link text-dark h6 border-0 mb-0 active" id="profile-tab"
                                data-toggle="tab" href="#profile" role="tab" aria-controls="profile"
                                aria-selected="false">Payment offers/Coupons</a>
                        </li>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <div class="bg-white shadow-sm rounded p-4 d-flex">
                                <div><img alt="#" src="{{asset('frontend')}}/img/axis.png" class="img-fluid"></div>
                                <div class="ml-4">
                                    <p class="mb-1 font-weight-bold">Get 4% cashback with Flipkart Axis Bank Credit Card</p>
                                    <p class="text-muted">Get 4% cashback on orders using Flipkart Axis Bank Credit Cards
                                    </p>
