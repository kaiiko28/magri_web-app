                                    ...
                                    <div class="col-lg-12">
                                        <div class="osahan-status">
                                            ...
                                            <div class="p-3 border-bottom">
                                                <div class="d-flex">
                                                    <h6 class="font-weight-bold">Order Status</h6><span class="ml-auto"><a class="btn btn-primary" href="{{route('map')}}">Track on map</a></span>
                                                </div>
                                            ...
                                            <div class="p-3 border-bottom">
                                                <p class="font-weight-bold small mb-1">Courier</p><img alt="#" class="img-fluid sc-osahan-logo mr-2" src="{{asset('frontend')}}/img/logo_web.png"> <span class="small text-primary font-weight-bold">Swiggiweb Courier</span>
                                            </div>
                                            <div class="p-3 border-bottom bg-white">
