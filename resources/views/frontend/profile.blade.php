                    ...
                    <div class="col-md-4 mb-3">
                        <div class="bg-white rounded shadow-sm sticky_sidebar overflow-hidden">
                            ...
                            <div class="d-flex align-items-center p-3">
                                <div class="left mr-3"><img alt="#" class="rounded-circle" src="img/user1.jpg"></div>
                                <div class="right">
                            ...
                            <div class="bg-white profile-details">
                                ...
                                <div class="right ml-auto">
                                    <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
                                </div></a> <a class="d-flex w-100 align-items-center border-bottom px-3 py-4" href="faq.html">
                                <div class="left mr-3">
                                ...
                                <div class="right ml-auto">
                                    <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
                                </div></a> <a class="d-flex w-100 align-items-center border-bottom px-3 py-4" href="contact-us.html">
                                <div class="left mr-3">
                                    <h6 class="font-weight-bold m-0 text-dark"><i class="feather-phone bg-primary text-white p-2 rounded-circle mr-2"></i> Contact</h6>
                                </div>
                                <div class="right ml-auto">
                                    <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
                                </div></a> <a class="d-flex w-100 align-items-center border-bottom px-3 py-4" href="terms.html">
                                <div class="left mr-3">
                                ...
                                <div class="right ml-auto">
                                    <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
                                </div></a> <a class="d-flex w-100 align-items-center px-3 py-4" href="privacy.html">
                                <div class="left mr-3">
                            ...
                            <div id="edit_profile">
                                ...
                                <div class="additional">
                                    <div class="change_password my-3">
                                        <a class="p-3 border rounded bg-white btn d-flex align-items-center" href="forgot_password.html">Change Password <i class="feather-arrow-right ml-auto"></i></a>
                                    </div>
                                    <div class="deactivate_account">
                                        <a class="p-3 border rounded bg-white btn d-flex align-items-center" href="forgot_password.html">Deactivate Account <i class="feather-arrow-right ml-auto"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
